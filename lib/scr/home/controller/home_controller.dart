...
// }
  ...
  GetWaitingOrdersModel? deliveredOrder;

  getdeliveredOrderOrders() async {
    GetDeliveredOrderAPI getgReceivedOrdersAPI = GetDeliveredOrderAPI();
    ...
    getgReceivedOrdersAPI.post(a).then((value) {
      deliveredOrder = value as GetWaitingOrdersModel;

      print("deliveredOrder  ${ deliveredOrder?.result?.detailsOrder?.length}");
      update();
    });
  }
...
print(myWalletModel?.toJson());
  ...
  getChangeStatusOrder({required id_order,
    ...
    a['status'] = action;
    if (action == 3) {
      LocationData? locationData = await LoctionServ.getCurLoction();
      a['lang'] = locationData?.latitude;
      a['long'] = locationData?.longitude;
    }
  ...
  updatesttae(int pos) {
    getOrderDetailsModel!.result!
        .allProducts![pos].productStatus = "0";
    getChangeStatusItemOrder(
        id_order: getOrderDetailsModel!.result!.orderDetails![0].idOrder,
        provider_id: getOrderDetailsModel!.result!
            .allProducts![pos].id!, updateId: getOrderDetailsModel!.result!
        .allProducts![pos].id!.toString()  );
    update();

    print(
        " getOrderDetailsModel!.result!.allProducts![pos].productStatus=>       ${ getOrderDetailsModel!
            .result!
            .allProducts![pos].productStatus}");
  }

  getChangeStatusItemOrder({required id_order,

    updateId, required int provider_id }) async {
    isChangeStatusOrder = true;
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        if(getOrderDetailsModel!.result!
                                            .allProducts![i].productStatus ==
                                            "1")
                                          GetBuilder<HomeViwController>(
                                              id: getOrderDetailsModel!.result!
                                                  .allProducts![i].idProduct
                                                  .toString(),
                                              builder: (logic) {
                                                return logic.isChangeStatusOrder
                                                    ? Center(
            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  GetBuilder<HomeViwController>(
                      id: getOrderUserDetailsModel!.result!
